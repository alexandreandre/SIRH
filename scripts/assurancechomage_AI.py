# scripts/assurancechomage_AI.py
...
def get_taux_chomage_via_ai() -> float | None:
    ...
    Le texte peut mentionner deux taux : un "avant" une certaine date et un "après".
    La date de référence pour notre calcul est aujourd'hui, le {date_actuelle_str}.
    
    Tu dois sélectionner le taux applicable à cette date de référence.
    ...
    Exemple de réponse attendue : 4.05
